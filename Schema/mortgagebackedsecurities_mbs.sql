...
CREATE TABLE `mbs` (
  `mbsID` varchar(30) NOT NULL DEFAULT '',
  `MonthlyValue` double DEFAULT NULL,
  `RemainingTerm` int(11) DEFAULT NULL,
  `TotalDefault` double DEFAULT NULL,
  `Income` double DEFAULT NULL,
  `PrePaymentAmount` double DEFAULT NULL,
  `LateIncome` double DEFAULT NULL,
  `NextDisbDate` date DEFAULT NULL,
  PRIMARY KEY (`mbsID`)
...
-- Dump completed on 2014-04-24 23:12:27
