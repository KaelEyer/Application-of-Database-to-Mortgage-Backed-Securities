...
CREATE TABLE `Tranches` (
  `TranchesID` varchar(30) NOT NULL DEFAULT '',
  `mbsID` varchar(30) DEFAULT NULL,
  `Attachment` double DEFAULT NULL,
  `Detachment` double DEFAULT NULL,
  `Income` double DEFAULT NULL,
  `Status` varchar(10) DEFAULT NULL,
  `AcctNumber` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`TranchesID`),
  KEY `fk_mbsID` (`mbsID`),
  CONSTRAINT `Tranches_ibfk_1` FOREIGN KEY (`mbsID`) REFERENCES `mbs` (`mbsID`)
