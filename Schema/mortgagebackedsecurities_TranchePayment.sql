...
--
-- Table structure for table `TranchePayment`
--

DROP TABLE IF EXISTS `TranchePayment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `TranchePayment` (
  `DueDate` date DEFAULT NULL,
  `SentDate` date DEFAULT NULL,
  `Amount` double DEFAULT NULL,
  `InvestorAccNumber` varchar(30) DEFAULT NULL,
  `TransPayID` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2014-04-24 23:12:25
